...
{
    /*
Códigos de retorno de validação:
...
*/
    ...
    public function setCodigoProfessor($professorFront)
    {
    ...
    public function consultar()
    {
        ...
        try {
            ...
            if (verificarParam($resultado, $lista) != 1) {
                ...
                foreach (
                    [
                        'Código' => $retornoCodigo,
                        'Data da Reserva' => $retornoDataReserva,
                        'Código da Sala' => $retornoCodSala,
                        'Código do Horário' => $retornoCodHorario,
                        'Código da Turma' => $retornoCodTurma,
                        'Código do Professor' => $retornoCodProfessor
                    ] as $campo => $retorno
                ) {
                    if ($retorno['codigoHelper'] != 0) {
                        $erros[] = ['codigo' => $retorno['codigoHelper'], 'campo' => $campo, 'msg' => $retorno['msg']];
                    }
                }
                */
                ...
                if ($retornoCodProfessor['codigoHelper'] != 0) {
                    $erros[] = [
                        'codigo' => $retornoCodProfessor['codigoHelper'],
                        'campo' => 'Código do porfessor',
                        'msg' => $retornoCodProfessor['msg']
                    ];
                }

                //Senao encontrar erros
                if (empty($erros)) {
