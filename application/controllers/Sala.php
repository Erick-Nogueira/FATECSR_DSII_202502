...
class Sala extends CI_Controller {
    /*
    Calidação dos tipos de retornios nas validações (Código de erro)
    1 - Operação realizada no banco de dados com sucesso (Inserção, Alteração, Consulta ou Exclusão)
    2 - Contéudo passado nulo ou vazio
    3 - Conteúdo zerado
    ...
    99 - Praâmetros passados do front não correspondem ao método
     */
    ...
    public function consultar() {
        ...
        try {
            ...
            if(verificarParam($resultado, $lista) != 1) {
                ...
                // Validar camos quanto ao tipo de dado e tamanho (Helper)
                ...
                if (empty($erros)) {
                    ...
                    $this->load->model('M_sala');
                    $resBanco = $this->M_sala->consultar($this->getCodigo(),
                                                        $this->getDescricao(),
                                                        $this->getAndar(),
                                                        $this->getCapacidade());
    ...
    public function alterar(){
        ...
        try {
            ...
            if (verificarParam($resultado, $lista) != 1) {
                ...
                //Pelo menos um dos três parâmetros prescisam ter dados para acontecer a atualização
    ...
    public function desativar() {
        ...
        try {
            ...
            $erros[] = ['codigo' => 0, 'msg' => 'Erros inseperado: ' . $e->getMessage()];
        }
