...
class Horario extends CI_Controller {
    ...
    12 - Na atualização, pelo menos um atributo de deve ser passado
...
/*---*/ // Transforma o array em JSON
    ...
    public function consultar() {
        ...
        try {
            ...
            $erros[] = ['codigo' => 0, 'msg' => 'Erro insperado: ' . $e->getMessage()];
        }

        //Montar retorno Único
        if ($sucesso == true) {
            $retorno = ['sucesso' => $sucesso, 'codigo' => $resBanco['codigo'],
                        'msg' => $resBanco['msg'],
    ...
    public function alterar() {
        ...
        try {
            ...
            if (verificarParam($resultado, $lista) != 1) {
                ...
                // Pelo menos um dos três parâmetros precisam estar presentes para acontecer a atualização
